...
\____/| .__/ \__,_|_| |_| |_| \____/|_| |_| |_|___/
	...
	def Spam():
		...
		if PilihTools == '1':
			...
			os.system('xdg-open http://wa.me/62895341201114?text=Assalamualaikum')
...
if __name__ == '__main__':
	print(C+'Subscribe YT'+W+' Gua Dlu Ya Cuk !'+C+' :V')
	sleep(2)
	os.system('clear')
	os.system('xdg-open https://www.youtube.com/channel/UCF61OnE5_ZG3k9LGg-s0e2A?sub_confirmation=1')
	sleep(7)
	Spam()